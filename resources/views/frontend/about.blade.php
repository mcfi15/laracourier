                    ...
                    <div class="col-12 col-lg-6">
                        <div class="title text-lg-left">
                            ...
                            <div class="title-heading">
                                <h1>{{ $appSetting->website_name }} is the World’s Famous Brands For Over 25 Years!</h1>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="about-img about-img-left">
                            <div class="about-img-warp bg-overlay">
                                <div class="bg-section"><img class="img-fluid" src="{{ asset('frontend/assets/images/about/1.jpg') }}"
                                        alt="about Image" /></div>
                            </div>
                            <div class="counter">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-7">
                                    <div class="block-left">
                                        <p>{{ $appSetting->website_name }} is a representative logistics operator providing full range of
                    ...
                    <div class="col-12 col-lg-6 offset-lg-1">
                        <div class="prief-set">
                            <p>We pride ourselves on providing the best transport and shipping services available
                                ...
                                chain solutions, {{ $appSetting->website_name }} drives sustainable competitive advantages to some of Australia's
                                largest companies.</p>
                        ...
                        <div class="col-12 col-lg-8 offset-lg-2">
                            <div class="heading heading-5 text-center">
                                ...
                                <p class="heading-desc">Our skilled personnel, utilising the latest communications,
                                    ...
                                    integrated supply chain solutions, {{ $appSetting->website_name }} drives sustainable competitive advantages
                                    to some of Australia's largest companies.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="carousel owl-carousel" data-slide="6" data-slide-rs="2" data-autoplay="true"
                                ...
                                <div class="client"><img src="{{ asset('frontend/assets/images/clients/1.png') }}" alt="client" /></div>
                                <div class="client"><img src="{{ asset('frontend/assets/images/clients/1.png') }}" alt="client" /></div>
                                <div class="client"><img src="{{ asset('frontend/assets/images/clients/1.png') }}" alt="client" /></div>
                                <div class="client"><img src="{{ asset('frontend/assets/images/clients/1.png') }}" alt="client" /></div>
                                <div class="client"><img src="{{ asset('frontend/assets/images/clients/1.png') }}" alt="client" /></div>
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="heading heading-8 heading-light">
                        ...
                        <h2 class="heading-title">{{ $appSetting->website_name }} To World’s Famous Brands!!</h2>
                        <p class="heading-desc">{{ $appSetting->website_name }} is a representative logistics operator providing full range
                            of service in the sphere of customs clearance transportation worldwide.</p>
                ...
                <!-- <div class="col-12 col-lg-6">
                    <div class="video video-1" id="video1">
                        {{-- <div class="bg-section"><img src="{{ asset('frontend/assets/images/video/4.jpg" alt="background') }}" /></div> --}}
                        <div class="player"><a class="popup-video" href="https://www.youtube.com/watch?v=7e90gBu4pas">
