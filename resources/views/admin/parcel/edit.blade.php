            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <a href="{{ url('/admin/parcel') }}" class="btn btn-primary btn-sm text-white float-end" >
                      ...
                      <br>
                    <form action="{{ url('/admin/parcel/'.$parcel->id) }}" method="POST" enctype="multipart/form-data"> 
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <table class="table table-bordered" id="table">
                                ...
                                <tr>
                                    <td>
                                        <input type="text" name="quantity" value="{{ $packages->quantity }}" class="form-control">
                                    </td>
                                    <td>
                                        <select name="type" class="form-control">
                                            <option value="{{ $packages->type }}">{{ $packages->type }}</option>
                                    ...
                                    <td>
                                        <input type="text" name="width" value="{{ $packages->width }}" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="height" value="{{ $packages->height }}" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="weight" value="{{ $packages->weight }}" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="length" value="{{ $packages->length }}" class="form-control">
                                    </td>
                                    <td>
                                        <textarea name="description" id="" class="form-control">{{ $packages->description }}</textarea>
                                    </td>
                                    {{-- <td>
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <input type="text" name="sender_name" value="{{ $parcel->sender_name }}" class="form-control"/>
                                @error('sender_name')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror

                                <label for="" class="col-form-label">Address</label>
                                <input type="text" name="sender_address" value="{{ $parcel->sender_address }}" class="form-control"/>
                                @error('sender_address')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror

                                <label for="" class="col-form-label">Contact #</label>
                                <input type="text" name="sender_contact" value="{{ $parcel->sender_contact }}" class="form-control"/>
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <label for="" class="col-form-label">Name</label>
                                <input type="text" name="reci_name" value="{{ $parcel->reci_name }}" class="form-control"/>
                                @error('reci_name')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                                ...
                                <label for="" class="col-form-label">Address</label>
                                <input type="text" name="reci_address" value="{{ $parcel->reci_address }}" class="form-control"/>
                                @error('reci_address')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror

                                <label for="" class="col-form-label">Contact #</label>
                                <input type="text" name="reci_contact" value="{{ $parcel->reci_contact }}" class="form-control"/>
                                @error('reci_contact')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-sm-12 mb-3">
                                ...
                                <input type="text" name="tracking_id" value="{{ $parcel->tracking_id }}" class="form-control"/>
                                @error('tracking_id')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <select name="status" class="form-control">
                                    <option value="{{ $parcel->status }}" selected>{{ $parcel->status }}</option>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" name="dep_date" value="{{ $parcel->dep_date }}" class="form-control"/>
                                @error('dep_date')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" name="pickup_date" value="{{ $parcel->pickup_date }}" class="form-control"/>
                                @error('pickup_date')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" name="exp_date" value="{{ $parcel->exp_date }}" class="form-control"/>
                                @error('exp_date')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-12 mb-3">
                                ...
                                <input type="text" name="carrier_no" value="{{ $parcel->carrier_no }}" class="form-control"/>
                                @error('carrier_no')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <select name="branch_pro" class="form-control">
                                    <option value="{{ $parcel->branch_pro }}" selected>{{ $parcel->branch_pro }}</option>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <select name="pickup_branch" class="form-control">
                                    <option value="{{ $parcel->pickup_branch }}">{{ $parcel->pickup_branch }}</option>
                                    @foreach ($branches as $branch)
                                        <option
                                            value="{{$branch->street.', '.$branch->city.', '.$branch->state.', '.$branch->zip_code.', '.$branch->country.' | '.$branch->contact.' | '.$branch->branch_code }}">{{$branch->street.', '.$branch->city.', '.$branch->state.', '.$branch->zip_code.', '.$branch->country.' | '.$branch->contact.' | '.$branch->branch_code }}</option>
                            ...
                            <div class="col-sm-12 mb-3">
                                ...
                                <input type="number" name="total_price" value="{{ $parcel->total_price }}" class="form-control"/>
                                @error('total_price')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            @if ($parcel->images)
                                @foreach ($parcel->images as $image)
                                    <div class="gallery">
                                        <a href="{{ url('admin/parcel-image/'.$image->id.'/delete') }}" class="btn btn-danger"><i class="ti ti-trash"></i></a>
