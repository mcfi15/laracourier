...
<div class="row">
    <div class="col-md-12 grid-margin">
        ...
        <form action="{{ route('parcel.post') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <table class="table table-bordered" id="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="text" name="inputs[0]quantity" class="form-control">
                                    </td>
                                    <td>
                                        <select name="inputs[0]type" class="form-control">
                                    ...
                                    <td>
                                        <input type="text" name="inputs[0]width" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="inputs[0]height" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="inputs[0]weight" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="inputs[0]length" class="form-control">
                                    </td>
                                    <td>
                                        <textarea name="inputs[0]description" id="" class="form-control"></textarea>
                                    </td>
                                    <td>
                                        <input type="text" name="inputs[0]price" class="form-control">
                                    </td>
                                    <td>
                                        <button type="button" name="add" id="add" class="btn btn-success"><i class="ti ti-plus"></i></button>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <div class="col-sm-12 mb-3">
                            <label for="" class="col-form-label">Tracking ID <span style="color:red">*</span></label>
                        ...
                        <div class="col-sm-6 mb-3">
                            ...
                            <input type="text" name="dep_date" class="form-control" />
                            @error('dep_date')
                                <small class="text-danger">{{ $message }}</small>  
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            ...
                            <select name="branch_pro" class="form-control">
                                ...
                                <option value="{{$branch->street.', '.$branch->city.', '.$branch->state.', '.$branch->zip_code.', '.$branch->country.' | '.$branch->contact.' | '.$branch->branch_code }}">{{$branch->street.', '.$branch->city.', '.$branch->state.', '.$branch->zip_code.', '.$branch->country.' | '.$branch->contact.' | '.$branch->branch_code }}</option>
